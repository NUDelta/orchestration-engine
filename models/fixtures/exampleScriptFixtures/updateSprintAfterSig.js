...
export default {
  ...
  description:
    'Students should send a revised SIG plan to their mentors after their SIG meetings.',
  timeframe: 'week',
  repeat: true,
  ...
  actionable_feedback: [
    {
      feedback_message:
        "Remember to send you revised sprint based on feedback from yesterday's SIG!",

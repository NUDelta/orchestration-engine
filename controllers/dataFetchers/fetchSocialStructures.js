...
const formatSocialStructureOrgObject = (socialStructureApiObj) => {
  ...
  let sigObj = socialStructureApiObj.kind === "SigStructure" ? {
  ...
  let onboardingObj = socialStructureApiObj.kind === "OnboardingPairing" ? {
    mentor: {
  ...
  let committeeObj = socialStructureApiObj.kind === "CommitteeStructure" ? {
